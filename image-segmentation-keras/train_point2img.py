...
def WriteTxT(history, TxTname):
    f = open(TxTname, 'w')
    #f.write("Accuracy")
    #f.writelines(history.accuracy['epoch'])
    f.write("Losses")
    f.writelines(history.losses['epoch'])
    #f.write("Val_Accuracy")
    #f.writelines(history.val_acc['epoch'])
    f.write("Val_Losses")
    f.writelines(history.val_loss['epoch'])
    f.close()

history = LossHistory()
wandb.init(project="0325_4000", entity = 'aipointcloud')
TxTname = "Output_Txt" + ".txt"

####Adjust the Parameter####
model = "mobilenet_segnet"
#train_images = "D:\Point2IMG\Original_Img_0331\Train_Img"
#train_annotations = "D:\Point2IMG\Original_Img_0331\Train_Label"
#Model_Path = "D:\image-segmentation-keras/_0331/Model/0331_model.h5"

train_images = "D:\Point2IMG\Original_Img_0331\Train_Img_Mix"
train_annotations = "D:\Point2IMG\Original_Img_0331\Train_Label_Mix"
Model_Path = "D:\image-segmentation-keras/_0331_mix/Model/0331_model.h5"
...
#checkpoints_path = "D:/image-segmentation-keras/_0331/CheckPoints/_0331"
checkpoints_path = "D:/image-segmentation-keras/_0331_mix/CheckPoints/_0331_mix"

epochs = 2400 #4201
batch_size = 10

validate = True
val_images = "D:\Point2IMG\Original_Img_0331\Val_Img"
val_annotations = "D:\Point2IMG\Original_Img_0331\Val_Label"
val_batch_size = 10
#val_split = 0
...
default_callback = ModelCheckpoint( 
            ...
            save_weights_only=True, period = 300, verbose=True)
callbacks = [default_callback, tf.keras.callbacks.TensorBoard(log_dir='.\\0331/logs'), history, WandbCallback()]

####### Never Change########
load_weights= None #"D:/image-segmentation-keras/0325/Output_0325_point/0325"
steps_per_epoch=512
val_steps_per_epoch=512
gen_use_multiprocessing=False
optimizer_name='adam'
do_augment= True #False
augmentation_name="aug_flip_and_rot" #"aug_all"
