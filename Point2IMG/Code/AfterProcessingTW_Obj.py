...
inpt_UnClippedtrain = motherfolder + "Val_Img/"#"UnClipped_Img_All/"
inpt_UnClippedLabel = motherfolder + "Val_Label/"#"UnClipped_Png_All/"

out_merge = predFolder
out_predict_folder = predFolder + "Predicted_Label"
...
def BackProjectionConf(filename, outImg, probImg, ignore_Zero = False):
...
def MissingValueCover(filename, binImg, inpt_UnClippedtrain):
    ...
    return (cover_binImg).astype('uint8')
...
if __name__ == "__main__":
    ...
    valList = [basename(i)[0:8] for i in valList]
    print(valList)
    ...
    for filename in fileList:
        ...
        #locationlist, croppedList, imgInfo = ARSEMimg.featImgCropper(featImg, 512, 512, 256) 
        ...
        SavePNG(out_merge + basename(filename)[0:-4] + '_prob' + '.png', (probImg[0]).astype('uint8') )
        ...
        BackProjectionConf(filename, outImg, probImg)